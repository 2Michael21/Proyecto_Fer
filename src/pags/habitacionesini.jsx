    ...
    return (
        <section>
            <div className='header'>
                ...
                <ul>
                    <li><NavLink to="/pag1">Inicio</NavLink></li>
                    <li><NavLink to="/habitacionesini">Habitaciones</NavLink></li>
                    <li><NavLink to="/reservaini">Reservar</NavLink></li>
                    <li><NavLink><a onClick={togglePergilModal}>Perfil</a></NavLink>
                    ...
                    <div className='catalogo'>
                        {habitacionesData.map(habitacion => (
                            <div className='det_catalogo' key={habitacion.id}>
                                ...
                                <div>
                                    <p className='explorar_cat'><NavLink to='/pagoini'>Reservar</NavLink></p>
                                </div>
                            </div>
                        ))}
                    </div>
...
export default Habitacionesini;
